...
/**
* This class represents a single flake, with properties representing its
...
public class SnowFlake {
    ...
    */
   static SnowFlake createFlake(float xRange, Bitmap originalBitmap) {
       ...
       flake.speed = 30 + (float) Math.random() * 200;
